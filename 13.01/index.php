<?php
//Логин - dyomin, пароль - php123
//Последняя посещенная страница выводится на странице links.php, где пользователю
//предложено перейти на fact.php или bitrix.php
//Задание, где нужно прервать сессию, находится в logout.php
session_start();
